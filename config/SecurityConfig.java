    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests((authorize) -> authorize
                        ...
                        .requestMatchers("/back/dashboard/**","/back/house/**","/back/device/**", "/back/booking/**", "/back/bill/**", "/back/report/**").hasAnyAuthority(ConstantUtil.ROLE_ADMIN, ConstantUtil.ROLE_LANDLORD)
                        .requestMatchers("/back/**").hasAuthority(ConstantUtil.ROLE_ADMIN)
                        .requestMatchers("/checkout", "/follow/**", "/profile**").hasAuthority(ConstantUtil.ROLE_TENANT)
